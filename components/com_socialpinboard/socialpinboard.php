...
//        $strDomainName = "http://iseofirm.net";
    ...
    function apiKey() {
        if (extension_loaded('mcrypt')) {
            ...
            $userApikey = socialpinboardHelper::getKey();
            if ($userApikey == '') {
                $userApikey = '0';
            }
            $appthaApiKey = $this->social_genenrate();
            if ($userApikey != $appthaApiKey) {
                $val = "<div style='text-align:center'><font style='font-size:14px; margin-top:15%; display:block; font-weight: bold; font-family: helvetica neue,arial,sans-serif;'>Invalid License Key </br></br>";
