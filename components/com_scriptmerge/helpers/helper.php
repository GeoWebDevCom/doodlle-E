...
class ScriptMergeHelper
{
    ...
    static public function getJsContent($file)
    {
        ...
        $compress_js = ScriptMergeHelper::getParams()->get('compress_js', false);
        if ($application->isSite() && !empty($compress_js)) {
            ...
            switch ($compress_js) {
                ...
                case 'phpjsmin':
                    // Compress the js-code using the jsmin() function-call
                ...
                case 'javascriptpacker':
                    // Compress the js-code using the JavaScriptPacker class
                    $packerFile = JPATH_SITE.'/components/com_scriptmerge/lib/class.JavaScriptPacker.php';
                    if(file_exists($packerFile)) {
                        include_once $packerFile;
     ...
     * @return none
     */
    static public function sendHttpHeaders($buffer, $params, $compression = false)
    {
