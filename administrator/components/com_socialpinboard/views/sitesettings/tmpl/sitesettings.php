...
<?php if ($Social_Pinboard == "0") { ?>
                <tr>
                    <td <?php if(!version_compare(JVERSION, '3.0.0', 'ge')){ echo 'style="padding-top:10px;padding-bottom:10px;"'; } ?> class="key hasTip" title="License Key">License Key </td>
                    <td>
                        <table><tr>
                                <td width="10"></td>
                                <td>
                                    <input <?php if(!version_compare(JVERSION, '3.0.0', 'ge')){ echo 'size="50px;"'; }?> type="text" name="lkey" id="lkey" value="" />
                                    <div>
                                        <a style="font-size: 12px; font-weight: bold; font-family: arial,sans-serif;" href="http://www.apptha.com/shop/checkout/cart/add/product/89" title="<?php echo JText::_('BUY NOW') ?>" target="_blank">
    <?php echo JText::_('BUY NOW') ?></a>
                                    </div>
                                </td>
                            </tr>
                        </table>
